...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.subtotal_label.sizePolicy().hasHeightForWidth())
        self.subtotal_label.setSizePolicy(sizePolicy)
        ...
        self.gridLayout.addWidget(self.subtotal_label, 1, 1, 1, 1)
